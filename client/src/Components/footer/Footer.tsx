...
export default function Footer() {
    return (
        ...
        <footer className="p-4  sm:p-6 dark:bg-gray-900" style={{"backgroundColor":"#fcf5eb"}}>
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" className="flex items-center">
                        ...
                        <span style={{"marginTop":"6px","fontFamily":"'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif","fontSize":"Larger","color":" rgb(240, 53, 131)"}}>Messenger</span>
                    </a>
                </div>
