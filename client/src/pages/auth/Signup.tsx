    ...
    <div className="m-16 mt-24  grid justify-items-center">
      ...
      <div className="border border-gray-100 shadow-md p-4 rounded-lg w-1/3 h-min">
        ...
        <div className="m-2 mb-4">
          <input type="text" ref={name} className="rounded-lg p-2 border border-gray-200 outline-0 w-full placeholder:text-gray-500 focus:placeholder:text-gray-400" id="" placeholder="Enter your userName" />
        </div>
        <div className="m-2 mb-4">
          <input type="email" ref={email} className="rounded-lg p-2 border border-gray-200 outline-0 w-full placeholder:text-gray-500 focus:placeholder:text-gray-400" id="" placeholder="Email here.." />
        </div>
        <div className="m-2 mb-4">
        ...
        <div className="m-2 mb-4">
          <input type="password" ref={cpassword} className="rounded-lg p-2 border border-gray-200 outline-0 w-full placeholder:text-gray-500 focus:placeholder:text-gray-400" id="" placeholder="Confirm Password" />
        </div>
        <div className="m-2 mb-4">
        ...
        <div className="mb-2 text-pinki-400 flex justify-center">
          <Link className=" hover:underline hover:underline-offset-4 hover:decoration-pinki-400" to="/login">Login</Link>
        </div>
      </div>
    </div>
  )
